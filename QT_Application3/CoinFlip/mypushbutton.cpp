...
MyPushButton::MyPushButton(QString normalImg, QString pressImg )//构造函数和头文件声明中的默认参数只能有一个
{
    ...
    //设置不规则图片样式(效果最好的)
    this->setStyleSheet("QPushButton{border:0px;}");//边框0像素,将边框去掉
